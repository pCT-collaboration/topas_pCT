function [P, S, MU] = Calibration(directory)
  ...
  for bricks = 0:4
    ...
    p1tOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker1t_Out.phsp"]);
    p1vOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker1v_Out.phsp"]);
    p2tOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker2t_Out.phsp"]);
    p2vOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker2v_Out.phsp"]);
    p3tOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker3t_Out.phsp"]);
    p3vOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker3v_Out.phsp"]);
    p4tOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker4t_Out.phsp"]);
    p4vOut = GetDataPhSp([directory "/" num2str(bricks) "/Tracker4v_Out.phsp"]);
    i = 1;
